...
// Define a default user object to showcase the component's structure and prevent errors.
const defaultUser = {
  name: "Mathimalar",
  id: "950023104031",
...
// Helper component for a single social link
const SocialLink = ({ name, icon, url }) => {
  // Map icons to their brand-specific Tailwind color classes
  const colorClasses = {
  ...
  const icons = {
    ...
    leetcode: <svg className="fill-current w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-3.134 6.942l-.527.712-.132.179c-.583.788-1.077 1.455-1.542 2.062-.465.607-.866 1.127-1.258 1.542-.392.415-.712.636-1.077.747l-1.42.368-1.53.395.77 1.95 2.13-1.066c.55-.275 1.134-.56 1.756-.867.622-.307 1.17-.55 1.583-.728l1.41-1.353-.198-.198c.55-.275 1.134-.56 1.756-.867.622-.307 1.17-.55 1.583-.728l1.41-1.353-.198-.198c.55-.275 1.134-.56 1.756-.867.622-.307 1.17-.55 1.583-.728l1.41-1.353-.198-.198c.55-.275 1.134-.56 1.756-.867.622-.307 1.17-.55 1.583-.728l1.41-1.353-.198-.198zm1.096 1.439l-.17.23-.228.308c-.783 1.059-1.442 1.944-2.071 2.766-.629.822-1.157 1.503-1.637 2.053-.48.55-1.014.928-1.434 1.196l-.99.59c-.48.286-.928.43-1.434.43-.506 0-1.014-.144-1.434-.43-.42-.267-.928-.646-1.434-1.196-.506-.55-1.014-.928-1.434-1.196-.42-.267-.928-.646-1.434-1.196l-1.033-.615-.558.948 1.44.821c.54.307 1.126.591 1.755.867.629.275 1.177.519 1.583.727l1.41 1.353.198.198c-.55.275-1.134.56-1.756.867-.622.307-1.17.55-1.583.728l-1.41 1.353.198.198c-.55.275-1.134.56-1.756.867-.622.307-1.17.55-1.583.728l-1.41 1.353.198.198c-.55.275 1.134-.56 1.756-.867.622-.307 1.17-.55 1.583-.728l1.41-1.353.198-.198c.55-.275 1.134-.56 1.756-.867.622-.307 1.17-.55 1.583-.728l1.41-1.353.198-.198z" /></svg>,
...
// Helper component for a single progress bar
...
// The main App component that renders the entire user profile page.
